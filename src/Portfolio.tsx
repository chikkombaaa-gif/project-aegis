        ...
        {SKILLS.map((s, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="mt-5 h-[3px] w-full overflow-hidden rounded-full bg-[oklch(0.22_0.005_260)]"
                role="progressbar"
        ...
        >
          ...
          <div className="mt-8 space-y-3">
            {items.map((it) => {
              ...
              const className =
                "group flex items-center justify-between rounded-2xl border border-[oklch(0.55_0.25_260/0.2)] bg-[oklch(0.15_0.05_260/0.4)] p-4 transition hover:border-[oklch(0.55_0.25_260/0.55)] hover:bg-[oklch(0.55_0.25_260/0.08)]";
              const inner = (
                <>
                  <div className="flex items-center gap-4">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[oklch(0.55_0.25_260/0.15)] text-[oklch(0.8_0.15_260)]">
